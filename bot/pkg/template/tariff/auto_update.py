...
async def prolonged_message(user_id: int, language_code: str, prolongable: bool = True) -> str:
...
async def disabled_message(user_id: int, language_code: str) -> str:
...
async def remaining_days_left_message(user_id: int, language_code: str, days_left: int) -> str:
