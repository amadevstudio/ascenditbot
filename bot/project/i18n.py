    ...
    'add_chat': {
        'instruction': {
            ...
            'ru':
                ...
                "с возможностью редактирования сообщений и просмотром других администраторов: зайдите"
                " в настройки группы (изменить) в Telegram, выберите пункт Администраторы,"
                f" нажмите на Добавить администратора и в поисковом поле введите {constants.bot_name}.\n\n"
                ...
                "Подсказка: чтобы написать от лица группы, зайдите в настройки группы (изменить) в Telegram,"
                " выберите пункт Администраторы, затем аккаунт и активируйте пункт Анонимность.\n"
                "Идентификатор можно получить, с помощью бота @myidbot\n\n"
                "Группа добавится, если ваш аккаунт есть в списке администраторов"
                " с возможностью редактирования сообщений,"
                " а также вы являетесь владельцем группы или владелец уже добавлял её в бот."
                " При проверке подписки используется аккаунт владельца группы"
        },
        'success': {
            'en': "",
            'ru':
