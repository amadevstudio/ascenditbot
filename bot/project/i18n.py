    ...
    'subscription': {
        ...
        'show': {
            ...
            'balance_warning': {
                'en': "",
                'ru':
                    "Внимание! Любая валюта на балансе в системе бота – это виртуальные очки, "
    ...
    'tariffs': {
        'index': {
            ...
            'ru':
                ...
                "Внимание! При смене тарифа до окончания срока его действия\n"
                "● при переходе на более дорогой тариф с вашего баланса будет списана;\n"
                "● или при переходе на более дешёвый на ваш баланс будет начислена;\n"
                "разница за все оставшиеся дни.\n"
                f"{emoji_codes.get('warning_sign', '')} Однако сумма за текущий день будет списана ещё раз!"
                " Таким образом, если вы будете постоянно менять тарифы, то ваш баланс будет уменьшаться"
                " вплоть до невозможности перейти на желаемый тариф."
        },
        'current': {
            'en': "",
